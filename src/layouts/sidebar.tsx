          ...
          <figure className="media-left">
            <div className="image is-rounded is-48x48">
              <Img className="bio-resourcecard-logo"
                   fluid={author.headshot.childImageSharp.fluid}/>
            </div>
          </figure>
  ...
  <div className="bio-page-sidebar-references-group">
    <p className="menu-label"
      ...
      <span style={{ textTransform: 'uppercase' }}
            className="bio-page-sidebar-references-reftype">{reftype}</span>
    </p>
    <div>
      {references.map(reference => (
        <Link to={`/${reftype}/${reference}`}
              key={reference}
    ...
    return (
      <div>
        ...
        <main className="bd-main bulmaio-body">
          <div className="bd-side-background"></div>
          <div className="bd-main-container container">
            <div className="bd-duo">
              ...
              <aside className="bd-side bio-page-sidebar">
                ...
                <ReferenceGroup reftype="technologies" accent="danger"
                                references={this.props.sidebar.technologies}
                />
                <ReferenceGroup reftype="topics" accent="primary"
                                references={this.props.sidebar.topics}
                />
              </aside>
