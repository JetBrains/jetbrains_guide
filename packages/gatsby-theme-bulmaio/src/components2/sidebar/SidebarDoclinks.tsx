...
const Doclink: React.FC<Doclink> = ({ label, target }) => (
  <li>
    <ScrollLink data-testid={`sapl-link`} activeClass="active" to={target} spy={true} smooth={true} offset={0} duration={500} style={{ width: 'auto' }}>
      {label}
    </ScrollLink>
  </li>
);
...
const SidebarDoclinks: React.FC<SidebarDoclinksProps> = (
  { links }
  ) => (
