...
const Tip: FC<TipProps> = (
    ...
    let shortPosterURL = '', longPosterURL = '';
    if (shortVideo && shortVideo.poster) shortPosterURL = shortVideo.poster.publicURL;
    if (longVideo && longVideo.poster) longPosterURL = longVideo.poster.publicURL;
    ...
    const main = (
        <div style={{marginBottom: '3rem'}}>
            ...
            {longVideo && (
                <LongVideo
                    videoURL={longVideo.url}
                    authorLabel={tip.author.label}
                    slug={tip.slug}
                    posterURL={longPosterURL}
                    posterNumber={longVideo.posterNumber}
                />
            )}
