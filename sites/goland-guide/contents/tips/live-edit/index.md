...
leadin: |
  *Tired of starting a server a reloading your browser to see file changes?*
  ...
  The LiveEdit plugin for GoLand Professional (not bundled) is easy 
  to install and gives a great editing experience for HTML and CSS.
---

GoLand Professional bundles WebStorm and, with the optional LiveEdit plugin,
...
GoLand Professional "remote control" the browser, using an actual HTTP
URL.

As you type and save HTML and CSS, you'll see the changes in the browser.

In previous versions, GoLand needed a special extension in Chrome to allow
