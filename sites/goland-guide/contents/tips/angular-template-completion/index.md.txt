...
seealso:
  - title: 'GoLand Help for Angular'
    href: 'https://www.jetbrains.com/help/go/angular.html'
...
leadin: |
  *Angular template autocomplete gives tons of choices. Which one is best?*
  ...
  GoLand Professional's inclusion of WebStorm inherits its ongoing efforts 
...
WebStorm, and thus GoLand Professional, can follow that path and offer
