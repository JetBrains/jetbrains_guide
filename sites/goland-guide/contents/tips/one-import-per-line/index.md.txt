...
topics: [editing]
author: dlsniper
subtitle: Tell GoLand to put each import on a separate line when it cleans up your imports.
seealso:
  - title: Code Style Preferences for Python Imports
    href: 'https://www.jetbrains.com/help/go/2018.3/code-style-python.html#imports'
  - title: Optimize Imports
    href: 'https://www.jetbrains.com/help/go/2018.3/creating-and-optimizing-imports.html#optimize-imports-in-project'
...
GoLand's `Optimize Imports` acts as your import janitor and it
has settings which let you specify some options on style import. GoLand
2018.3 adds a preference: "One Import Per Line". With this setting in
place, GoLands `Optimize Imports` action will rewrite lines like this:
...
Don't forget, GoLand can also run the `Optimize Imports` action, with
