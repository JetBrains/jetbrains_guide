...
In this tutorial, we will use a Git demo project available on [GitHub](https://github.com/mlvandijk/gitdemo).
In this example, we use [TDD (Test Driven Development)](https://martinfowler.com/bliki/TestDrivenDevelopment.html) to add a new feature.
We start by adding a failing test, writing the minimum of code we need to get that test to pass and finally do some refactoring.
