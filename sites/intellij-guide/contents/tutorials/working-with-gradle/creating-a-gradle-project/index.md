...
IntelliJ IDEA creates the basic project structure, with a minimal build.gradle file, and you'll see Gradle is building the project. Once this finishes, the project window will show the structure of the project, with the standard Gradle directory structure. We'll look at the project in more detial in the next section.
