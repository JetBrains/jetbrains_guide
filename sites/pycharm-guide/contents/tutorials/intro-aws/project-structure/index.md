...
Below we have the PyCharm Professional 2020.3 `New Project` screen. I will be choosing the **AWS Serverless Application**.
...
There is something new added to the Interface called **Package Type** which provides two options **Zip** & **Archive**.
...
The heart of this application is **template.yaml** file.
...
something like **“description”**, **“template version”**. This is the global information about your functions. All the functions will be getting time-out after 3 seconds. You can also define your memory requirements.
...
So, in the lambda function you must observed something called **events** & **context**. 
...
Apart from context there is one more thing passed called as **events**.
